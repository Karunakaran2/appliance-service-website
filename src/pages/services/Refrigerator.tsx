...
import { Phone, MessageCircle, Thermometer, ShieldCheck } from 'lucide-react';
...
const Refrigerator = () => {
  ...
  const serviceData = getServiceBySlug('refrigerator');
    ...
    <div className="pt-20">
      ...
      <section className="relative h-[50vh] flex items-center justify-center">
        <div className="absolute inset-0">
          <img
            src={serviceData?.image || "/assets/images/placeholders/refrigerator.png"}
