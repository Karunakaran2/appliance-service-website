...
import { CheckCircle, Phone, MessageCircle, ShieldCheck, Thermometer } from 'lucide-react';
import { siteConfig } from '../../data/siteConfig';
import { getServiceBySlug } from '../../data/servicesData';

const ACService = () => {
  const { t } = useTranslation();
  const serviceKey = 'serviceDetails.ac-service';
  const serviceData = getServiceBySlug('ac-service');
    ...
    <div className="pt-20">
      ...
      <section className="relative h-[50vh] flex items-center justify-center">
        <div className="absolute inset-0">
          <img
            src={serviceData?.image || "/assets/images/placeholders/ac-service.png"}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
             ...
             <div className="lg:w-1/2 order-1 lg:order-2">
                <div className="relative rounded-3xl overflow-hidden shadow-xl h-64 lg:h-auto">
                  <img 
                    src="/assets/images/placeholders/ac-service.png" 
                    alt="Why Choose Us" 
                    className="w-full h-full object-cover"
                  />
                </div>
